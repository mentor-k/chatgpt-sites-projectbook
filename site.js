(() => {
  ...
  if (footer) footer.innerHTML = '<footer class="global-footer"><a class="footer-brand" href="/"><b>AIWITH</b><span>AI와 함께 배우고, 만들고, 성장하다</span></a><div class="footer-nav"><a href="/">HOME</a><a href="/website/">웹사이트 스쿨</a><a href="/content-school/">콘텐츠스쿨</a><a href="/proposal-school/">기획서·사업계획서 스쿨</a><a href="/prompt/">AI 프롬프트랩</a><a href="/book-school/">책쓰기 스쿨</a><a href="/workshops/">강의·워크숍</a><a href="/columns/">멘토K 컬럼</a><a href="/cardnews/">카드뉴스</a><a href="/notices/">공지사항</a><a href="/consultation/">상담 신청</a></div><div class="footer-legal" aria-label="이용약관·개인정보처리방침·소유·저작권 안내"><details id="terms"><summary>이용약관</summary><div class="legal-copy"><p>AIWITH는 AI 교육·콘텐츠·웹사이트·프롬프트·책쓰기·강의·워크숍 정보를 제공하는 서비스입니다. 이용자는 서비스의 안내와 콘텐츠를 학습·업무·기획 보조 목적으로 활용할 수 있습니다.</p><p>AI가 생성한 결과와 사이트 자료는 사실성·최신성·법적 적합성·저작권·개인정보 보호 여부를 이용자가 최종 확인해야 합니다. 근거 없는 내용의 재배포, 타인의 권리를 침해하는 사용, 서비스 운영을 방해하는 자동 수집·복제·재판매는 금지됩니다.</p><p>상담·교육 신청 시 입력한 정보는 요청한 안내와 진행을 위해 사용되며, 이용자는 언제든 정정·삭제를 요청할 수 있습니다. 운영상 필요한 경우 사전 안내 후 내용을 변경할 수 있습니다.</p></div></details><details id="privacy"><summary>개인정보처리방침</summary><div class="legal-copy"><p>수집 항목은 상담·신청 과정에서 이용자가 직접 입력한 이름, 기관·기업명, 연락처, 이메일, 상담 분야와 문의 내용입니다. 접속·검색·복사와 같은 이용 기록은 서비스 개선과 관리자 통계를 위해 처리될 수 있습니다.</p><p>개인정보는 상담 응대, 강의·워크숍 안내, 신청 확인과 운영 기록 관리 목적에 한해 사용하며, 목적이 달성되거나 보관기간이 끝나면 지체 없이 삭제합니다. 법령에 따른 보존이 필요한 경우에는 해당 기간 동안 안전하게 보관합니다.</p><p>개인정보는 이용자의 동의 없이 제3자에게 제공하지 않습니다. 처리 위탁이나 외부 서비스 연동이 필요한 경우 대상·목적·보유기간을 안내합니다. 개인정보 문의·열람·정정·삭제 요청은 상담 신청 경로로 접수해 주세요.</p></div></details><details id="copyright"><summary>소유·저작권 안내</summary><div class="legal-copy"><p>AIWITH의 브랜드, 로고, 화면 구성, 문구, 강의 자료, 프롬프트 데이터베이스, 카드뉴스와 편집 저작물은 엠아이넥스트㈜ 및 김용한 박사(멘토K)에게 권리가 있습니다.</p><p>사이트 콘텐츠는 개인 학습과 정당한 업무 활용 범위에서 이용할 수 있으나, 출처 없는 재게시·대량 수집·상업적 재판매·무단 편집·브랜드 오용은 허용하지 않습니다. 인용이나 공유가 필요한 경우 원문 링크와 출처를 표시해 주세요.</p><p>외부 모델·이미지·폰트·상표·원문 자료는 각 권리자의 이용 조건을 따릅니다. 권리 침해가 의심되는 자료는 확인 즉시 문의해 주시면 검토 후 조치하겠습니다.</p></div></details></div><p>© 2026 AIWITH · 엠아이넥스트㈜ · 김용한 박사(멘토K)</p></footer>
