...
const viewTitles={home:"AI위드스쿨 프롬프트랩",commands:"이미지 치트키",work:"업무 프롬프트",planning:"기획 프롬프트",recipes:"이미지 활용",imageGuide:"GPT Image 2.5",astra:"Astra 활용",website:"웹사이트",app:"앱 구축",shop:"쇼핑몰·자사몰",builder:"프롬프트 설계",guide:"초보자 가이드"};
