...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  document.getElementById('closeToolModal')?.addEventListener('click',()=>document.getElementById('toolModal').hidden=true);document.getElementById('toolModal')?.addEventListener('click',e=>{if(e.target.id==='toolModal')e.currentTarget.hidden=true});
